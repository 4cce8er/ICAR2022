...
cd ${BINARY_ROOT}
$PIN_ROOT/pin -t $TRACER_ROOT/obj-intel64/memory_tracer.so -o ${OUTPUT_NAME} -- ./${BINARY_NAME} 10 reference.dat 0 0 100_100_130_ldc.of 3>&1 1>&2 2>&3 | gzip > ${OUTPUT_NAME}_trace.gz
